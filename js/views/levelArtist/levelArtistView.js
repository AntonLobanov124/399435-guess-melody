...
export default class LevelArtistView extends AbstractView {
  constructor() {
    ...
    this._mainListNode = this.element.querySelector(`.main-list`);
  }
  ...
  set answers(answers) {
    this._mainListNode.innerHTML = answers.map(([index, track]) => {
    ...
    Array.from(this._mainListNode.querySelectorAll(`.main-answer-r`)).forEach((el) => {
